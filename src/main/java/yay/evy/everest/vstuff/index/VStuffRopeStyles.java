...
import yay.evy.everest.vstuff.internal.RopeStyles.PrimitiveRopeStyle;
...
public class VStuffRopeStyles {
    ...
    private static final RopeStyle LIGHT_GRAY = new RopeStyle("light_gray_dye", PrimitiveRopeStyle.DYE, "vstuff.rope.light_gray");
    private static final RopeStyle GRAY = new RopeStyle("gray_dye", PrimitiveRopeStyle.DYE, "vstuff.rope.gray");
    private static final RopeStyle BLACK = new RopeStyle("black_dye", PrimitiveRopeStyle.DYE, "vstuff.rope.black");
    private static final RopeStyle BROWN = new RopeStyle("brown_dye", PrimitiveRopeStyle.DYE, "vstuff.rope.brown");
    private static final RopeStyle RED = new RopeStyle("red_dye", PrimitiveRopeStyle.DYE, "vstuff.rope.red");
    private static final RopeStyle ORANGE = new RopeStyle("orange_dye", PrimitiveRopeStyle.DYE, "vstuff.rope.orange");
    private static final RopeStyle YELLOW = new RopeStyle("yellow_dye", PrimitiveRopeStyle.DYE, "vstuff.rope.yellow");
    private static final RopeStyle LIME = new RopeStyle("lime_dye", PrimitiveRopeStyle.DYE, "vstuff.rope.lime");
    private static final RopeStyle GREEN = new RopeStyle("green_dye", PrimitiveRopeStyle.DYE, "vstuff.rope.green");
    private static final RopeStyle CYAN = new RopeStyle("cyan_dye", PrimitiveRopeStyle.DYE, "vstuff.rope.cyan");
    private static final RopeStyle LIGHT_BLUE = new RopeStyle("light_blue_dye", PrimitiveRopeStyle.DYE, "vstuff.rope.light_blue");
    private static final RopeStyle BLUE = new RopeStyle("blue_dye", PrimitiveRopeStyle.DYE, "vstuff.rope.blue");
    private static final RopeStyle PURPLE = new RopeStyle("purple_dye", PrimitiveRopeStyle.DYE, "vstuff.rope.purple");
    private static final RopeStyle MAGENTA = new RopeStyle("magenta_dye", PrimitiveRopeStyle.DYE, "vstuff.rope.magenta");
    private static final RopeStyle PINK = new RopeStyle("pink_dye", PrimitiveRopeStyle.DYE, "vstuff.rope.pink");
    private static final RopeStyle WHITE = new RopeStyle("white_dye", PrimitiveRopeStyle.DYE, "vstuff.rope.white");
