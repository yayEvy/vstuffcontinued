...
public class VStuffRopeStyles {
    ...
    private static final RopeStyle LIGHT_GRAY_WOOL = new RopeStyle("light_gray_dye_wool", PrimitiveRopeStyle.WOOL, "block.minecraft.light_gray_wool");
    private static final RopeStyle GRAY_WOOL = new RopeStyle("gray_dye_wool", PrimitiveRopeStyle.WOOL, "block.minecraft.gray_wool");
    private static final RopeStyle BLACK_WOOL = new RopeStyle("black_dye_wool", PrimitiveRopeStyle.WOOL, "block.minecraft.black_wool");
    private static final RopeStyle BROWN_WOOL = new RopeStyle("brown_dye_wool", PrimitiveRopeStyle.WOOL, "block.minecraft.brown_wool");
    private static final RopeStyle RED_WOOL = new RopeStyle("red_dye_wool", PrimitiveRopeStyle.WOOL, "block.minecraft.red_wool");
    private static final RopeStyle ORANGE_WOOL = new RopeStyle("orange_dye_wool", PrimitiveRopeStyle.WOOL, "block.minecraft.orange_wool");
    private static final RopeStyle YELLOW_WOOL = new RopeStyle("yellow_dye_wool", PrimitiveRopeStyle.WOOL, "block.minecraft.yellow_wool");
    private static final RopeStyle LIME_WOOL = new RopeStyle("lime_dye_wool", PrimitiveRopeStyle.WOOL, "block.minecraft.lime_wool");
    private static final RopeStyle GREEN_WOOL = new RopeStyle("green_dye_wool", PrimitiveRopeStyle.WOOL, "block.minecraft.green_wool");
    private static final RopeStyle CYAN_WOOL = new RopeStyle("cyan_dye_wool", PrimitiveRopeStyle.WOOL, "block.minecraft.cyan_wool");
    private static final RopeStyle LIGHT_BLUE_WOOL = new RopeStyle("light_blue_dye_wool", PrimitiveRopeStyle.WOOL, "block.minecraft.light_blue_wool");
    private static final RopeStyle BLUE_WOOL = new RopeStyle("blue_dye_wool", PrimitiveRopeStyle.WOOL, "block.minecraft.blue_wool");
    private static final RopeStyle PURPLE_WOOL = new RopeStyle("purple_dye_wool", PrimitiveRopeStyle.WOOL, "block.minecraft.purple_wool");
    private static final RopeStyle MAGENTA_WOOL = new RopeStyle("magenta_dye_wool", PrimitiveRopeStyle.WOOL, "block.minecraft.magenta_wool");
    private static final RopeStyle PINK_WOOL = new RopeStyle("pink_dye_wool", PrimitiveRopeStyle.WOOL, "block.minecraft.pink_wool");
    private static final RopeStyle WHITE_WOOL = new RopeStyle("white_dye_wool", PrimitiveRopeStyle.WOOL, "block.minecraft.white_wool");
