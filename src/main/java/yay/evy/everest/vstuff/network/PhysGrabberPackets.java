...
public class PhysGrabberPackets {
    ...
    public static class ReleasePacket {
        private final long shipId;
        public ReleasePacket(long shipId) { this.shipId = shipId; }
        public static void encode(ReleasePacket msg, FriendlyByteBuf buf) { buf.writeLong(msg.shipId); }
        public static ReleasePacket decode(FriendlyByteBuf buf) { return new ReleasePacket(buf.readLong()); }
