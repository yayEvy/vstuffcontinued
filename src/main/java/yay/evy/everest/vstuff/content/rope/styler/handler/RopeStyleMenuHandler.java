...
import yay.evy.everest.vstuff.content.rope.styler.RopeStylerScreen;
import yay.evy.everest.vstuff.index.VStuffItems;
import yay.evy.everest.vstuff.index.VStuffKeys;
import yay.evy.everest.vstuff.foundation.utility.EntityUtils;
...
public class RopeStyleMenuHandler {
    ...
    public static void onKeyInput(int key, boolean pressed) {
        ...
        boolean holdingLead = EntityUtils.isHolding(player, VStuffItems.ROPE_ITEM::isIn);
