package yay.evy.everest.vstuff.content.ropes.overlay;
...
public class RopeHovering {
    ...
    public static class RopeInfo {
        ...
        public static RopeInfo tryConnect(Level level, Player player, BlockPos pos, Long ship, String dimId, BlockState hitState, ItemStack stack, boolean taut) {
            double maxLength = VStuffConfig.MAX_ROPE_LENGTH.get();
            ...
            if (level.isClientSide) {
                ...
                info.ship0 = ship0;
                info.localPos1 = RopeUtils.getLocalPos(level, pos);
                info.worldPos1 = ClientRopeUtil.renderLocalToWorld(level, info.localPos1, ship);
                info.ship1 = ship;
            }

            double length = info.worldPos0.distance(info.worldPos1);
    ...
    public static void clientTick() {
        ...
        Long ship = ShipUtils.getShipIdAtPos(level, pos);
